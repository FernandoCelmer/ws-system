...
if($_SESSION['system_user_level'] == 1){
	...
	$sql_res=mysql_query("SELECT * FROM system_download"); //consulta no banco
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row">
    ...
    <h5><i class="fa fa-share-alt"></i>  Download<?php echo " - Página <a'>".$pag." / ".$paginas."</a>"; ?></h5>
	</header>
  ...
  <div class="w3-row-padding w3-margin-bottom">
		<table class="w3-table w3-small w3-bordered w3-responsive w3-border">
			...
			<?php
				$sql="SELECT * FROM system_download ORDER BY system_download_attribute DESC LIMIT $inicio, $maximo"; //consulta no BD
		...
		<table class="w3-bar w3-border w3-round w3-center">
			...
			<?php
				if($pag!=1){
					echo "<td><a class='w3-bar-item w3-button w3-left w3-card-4' href='user-list.php?pag=".($pag-1)."'>&#10094; Anterior</a></td>"; 
				}
				echo "<td><a class='w3-center'>Página ".$pag." de ".$paginas."</a></td>";
				if($contador<=$maximo){
					...
					for($i=1;$i<=$paginas;$i++){
						if($pag==$i){
							//echo "<td class='w3-bar-item w3-button w3-white'><a href='user-list.php?pag=".$i."'> ".$i."</a></td>";
						}else{
							//echo "<td class='w3-bar-item w3-button w3-white'><a href='user-list.php?pag=".$i."'> ".$i."</a></td>";
						}
					}
				...
				if($pag!=$paginas){
					echo "<td><a class='w3-bar-item w3-button w3-right w3-card-4' href='user-list.php?pag=".($pag+1)."'>Próximo &#10095;</a></td>";
				}
			?>
		</tr>
		</table> 
