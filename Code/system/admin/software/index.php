...
if($_SESSION['system_user_level'] == 1){
	...
	$sql_res=mysql_query("SELECT * FROM desktop_software"); //consulta no banco
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row">
    ...
    <h5><i class="fa fa-window-maximize"></i>  Software</h5>
	</header>
  ...
  <div class="w3-row-padding w3-margin-bottom">
		<table class="w3-table w3-small w3-bordered w3-responsive w3-border">
			...
			<?php
				$sql="SELECT * FROM desktop_software ORDER BY id_desktop_software DESC LIMIT $inicio, $maximo"; //consulta no BD
				...
				$id = $res[id_desktop_software];
				$nome = $res[desktop_software_attribute];
			?>
			<tr>
				<td><?php echo $nome ?></td>
