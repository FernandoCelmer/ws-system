...
<h5><a class="w3-bar-item w3-button w3-hover-black" href="../admin/user/"><i class="fa fa-user"></i>  User</a>
	...
	<a class="w3-bar-item w3-button w3-hover-black" href="../admin/validation/"><i class="fa fa-key"></i>  Validation</a>
	<a class="w3-bar-item w3-button w3-hover-black" href="../admin/support/"><i class="fa fa-comment"></i>  Support</a>
	<a class="w3-bar-item w3-button w3-hover-black" href="../admin/feedback/"><i class="fa fa-eye"></i>  Feedback</a>
	<a class="w3-bar-item w3-button w3-hover-black" href="../admin/download/"><i class="fa fa-share-alt"></i>  Download</a></h5>
</nav>
