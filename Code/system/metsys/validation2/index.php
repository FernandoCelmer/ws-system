...
if($_SESSION['system_user_level'] == 1){
	...
	$sql_res=mysql_query("SELECT * FROM desktop_validation"); //consulta no banco
...
<div class="w3-top">
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
    <a class="w3-bar-item w3-button w3-right w3-hide-large w3-hover-white w3-large w3-theme-l1" href="javascript:void(0)" onclick="w3_open()"><i class="fa fa-bars"></i></a>
	 ...
	 <a href="../validation/new-form.php" class="w3-bar-item w3-button w3-right"><i class="fa fa-plus"></i></a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row-padding w3-margin-bottom">
		<table class="w3-table w3-small w3-bordered w3-responsive w3-border">
			<tr>
				<td width="130" align='left'><b>Status</b></td>
				<td width="175" align='left'><b>DateTime</b></td>
				<td><b>Software</b></td>
				<td align='right' width="25"><b></b></td>
			</tr>
			<?php
				$sql="SELECT * FROM desktop_validation A inner join desktop_software B on A.id_desktop_software = B.id_desktop_software ORDER BY id_desktop_validation DESC LIMIT $inicio, $maximo"; //consulta no BD
				...
				$id = $res[id_desktop_validation];
				$serial = $res[desktop_validation_serial];
				$software = $res[desktop_software_attribute];
				$status = $res[desktop_validation_status];
				$activation = $res[desktop_validation_activation];
				$date = $res[desktop_validation_datetime];
			?>
			<tr>
				<td><?php if($status == "TRUE"){ echo "<span class='w3-tag w3-light-green w3-round'><i><i class='fa fa-check'></i>  Aprovado</i></span>";}else echo "<span class='w3-tag w3-light-grey w3-round'><i><i class='fa fa-spinner'></i>  Processando</i></span>";?></td>				
				<td><i class='fa fa-calendar'></i>  <?php echo $date ?></td>
				<td><?php echo $software ?></td>
				<td>
<?php if($software == "TurControl"){echo "<a href='../validation/turcontrol/index.php?id=".($id)."'><i class='fa fa-share'></i></a>";}?>
<?php if($software == "WControl"){echo "<a href='../validation/wcontrol/index.php?id=".($id)."'><i class='fa fa-share'></i></a>";}?>
<?php if($software == "WouSoftware"){echo "<a href='../validation/wousoftware/index.php?id=".($id)."'><i class='fa fa-share'></i></a>";}?>				
