...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    ...
    <h5><i class="fa fa-window-maximize"></i>  Licenças</h5>
  </header>
  ...
  <?php
        $res = mysql_query("select * from system_validation where id_system_user= '".$_SESSION['id_system_user']."'"); /* Executa o comando SQL, no caso para pegar todos os dados e retornar o valor da consulta em uma variavel ($res)  */
        ...
        while ($mostrar = mysql_fetch_array($res)) {
            ...
            echo "<tr>
                    <td>" . $mostrar['id_system_validation'] . "</td>
                    <td>" .$mostrar['system_validation_serial'] . "</td>
                    <td>" . $mostrar['system_validation_status'] . "</td>
                </tr>";
        }
