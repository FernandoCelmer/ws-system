...
<a href="../validation/new-form.php" class="w3-bar-item w3-button w3-right"><i class="fa fa-check"></i></a>
  ...
  <div class="w3-row">
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-black w3-card-4">
        <div class="w3-display-container">
          <img src='../turcontrol/images/banner_turcontrol.jpg' style='width:100%' alt='Avatar'>		  
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card-2 w3-white w3-margin-bottom">
		...
		<i class='fa fa-bus fa-fw w3-margin-right w3-xxlarge w3-text-black'></i><?php echo @$software['desktop_software_attribute']; ?></h2>
        <div class="w3-container">
