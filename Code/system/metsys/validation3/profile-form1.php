...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row">
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-black w3-card-4">
        <div class="w3-display-container">
          <img src='wousoftware/images/banner_wousoftware.jpg' style='width:100%' alt='Avatar'>		  
	...
	?>
		...
		'<a href="pag-wousoftware.php?id='.$exibe['id_desktop_validation'].'">Ir para o Checkout - R$ 00,01</a>';}
		?>  
