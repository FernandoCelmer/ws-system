...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row-padding w3-margin-bottom">
		...
		<li><i class="fa fa-window-maximize"></i><b> <?php echo $software ?></b> - <?php if($activation == "TRUE"){ echo "Ativado";}else echo "Desativado";?><p>
		<i class="fa fa-key"></i> <?php echo $serial ?><p>		
		<?php if($status == "TRUE"){ echo "<span class='w3-tag w3-light-green w3-round'><i><i class='fa fa-check'></i>Aprovado</i></span>";}else echo "<span class='w3-tag w3-light-grey w3-round'><i><i class='fa fa-check'></i>Em Andamento</i></span>";?> <?php if($status == "TRUE"){ }else echo " - ","<a href='#'>Fazer Pagamento</a>";?><p>
