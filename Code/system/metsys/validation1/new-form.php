...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row-padding w3-margin-bottom">
        ...
        <h6 class="w3-opacity">Comprar Licença:</h6>

		<form name="Cadastro" action="new.php" method="POST"> 
		<div class="w3-half">
		<input class="w3-input w3-border w3-padding" type="text" maxlength="50" name="desktop_validation_serial" value="<?php echo randString(4),"-",randString(4),"-",randString(4),"-",randString(4); ?>" readonly="true" >
		</div>
		<div class="w3-half">
		
		<select class="w3-select w3-input w3-border w3-padding" name="id_desktop_software" name="option" >
		<option value="1"selected>TurControl</option>
		</select><p>
		</div><p>
		<input class="w3-button w3-theme" type="submit" name="enviar" value="Gerar Licença"> 
		</form> 
		<br/>
