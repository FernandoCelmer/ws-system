  ...
  <div class="w3-row-padding w3-margin-bottom">
		<table class="w3-table w3-small w3-bordered w3-responsive w3-border">
			<tr>
				...
				<td><b>Ativação</b></td>
				<td><b>Status</b></td>				
				<td align='right' width="121"><b></b></td>
				<td align='right' width="121"><b></b></td>
			</tr>
			<?php
		...
		<span class="w3-tag w3-tiny w3-light-grey w3-round"><i><i class="fa fa-calendar"></i> <?php echo $datetime ?></i></span>		
				...
				<td><?php if($activation == "TRUE"){ echo "Ativado";}else echo "Desativado";?></td>
				<td><?php if($status == "TRUE"){ echo "Aprovado";}else echo "Em Andamento";?></td>				
				<td><?php if($status == "TRUE"){ }else echo "<a href='#'>Fazer Pagamento</a>";?></td>
				<td>		
