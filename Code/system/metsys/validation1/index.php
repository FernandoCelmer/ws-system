...
<div class="w3-top">
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
    <a class="w3-bar-item w3-button w3-right w3-hide-large w3-hover-white w3-large w3-theme-l1" href="javascript:void(0)" onclick="w3_open()"><i class="fa fa-bars"></i></a>
	 ...
	 <a href="new-form.php" class="w3-bar-item w3-button w3-right"><i class="fa fa-plus"></i></a>
...
<h5><a class="w3-bar-item w3-button w3-hover-black" href="../user/"><i class="fa fa-user"></i>  User</a>
	...
	<a class="w3-bar-item w3-button w3-hover-black" href="../validation/"><i class="fa fa-key"></i>  Validation</a>
	<a class="w3-bar-item w3-button w3-hover-black" href="../support/"><i class="fa fa-comment"></i>  Support</a>
	<a class="w3-bar-item w3-button w3-hover-black" href="../feedback/"><i class="fa fa-eye"></i>  Feedback</a>
	<a class="w3-bar-item w3-button w3-hover-black" href="../download/"><i class="fa fa-share-alt"></i>  Download</a></h5>
</nav>
