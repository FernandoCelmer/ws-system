...
if($_SESSION['system_user_level'] == 0){ header('location: ../system/user/');}
...
<div class="w3-rest">
      <input class="w3-input w3-border" type="text" value="<?php echo @$exibe['system_user_email']; ?>" placeholder="E-mail" readonly="true"><p/>
</div>  

<div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-key "></i></div>
<div class="w3-rest">
      <input class="w3-input w3-border" type="text" value="<?php echo @$exibe['desktop_validation_serial']; ?>" placeholder="Serial" readonly="true"><p/>
</div>  
