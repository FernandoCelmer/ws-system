...
if($_SESSION['system_user_level'] == 1){
	...
	$sql_res=mysql_query("SELECT * FROM desktop_validation where id_system_user= '".$_SESSION['id_system_user']."'"); //consulta no banco
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row-padding w3-margin-bottom">
		<table class="w3-table w3-small w3-bordered w3-responsive w3-border">
			...
			<?php
				$sql="SELECT * FROM desktop_validation A inner join desktop_software B on A.id_desktop_software = B.id_desktop_software where id_system_user= '".$_SESSION['id_system_user']."' ORDER BY id_desktop_validation DESC LIMIT $inicio, $maximo"; //consulta no BD
			...
			<tr>
				...
				<td><a href="../validation/profile-form.php?id=<?php echo $id ?>"><i class="fa fa-share"></i></a></td>
			</tr>
			<?php } ?>
		</table >
