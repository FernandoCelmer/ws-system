...
<?php if($exibe['desktop_validation_status'] == "TRUE"){
		
		if($exibe['desktop_validation_activation'] == "TRUE"){
		echo "<i class='fa fa-check-circle-o'></i> Software Ativado";}
		else 
		echo"<i class='fa fa-times-circle-o'></i> Software Desativado"; 
		...
		'<a href="pagseguro/pag-wousoftware.php?id='.$exibe['id_desktop_validation'].'">Ir para o Checkout - R$ 00,01</a>';}
		?>  
...
"<p>Detalhes</p>
        <p>
        <center><span class='w3-tag w3-small w3-theme-d5'><i class='fa fa-windows' aria-hidden='true'></i>  Windows XP/Vista/7/8/10</span>
        <span class='w3-tag w3-small w3-theme-d1'><i class='fa fa-desktop' aria-hidden='true'></i> 10.5 MB</span>
        <span class='w3-tag w3-small w3-theme-l1'><i class='fa fa-wrench' aria-hidden='true'></i> 1.0</span>
...
"<p>Detalhes</p>
        <p>
        <center><span class='w3-tag w3-small w3-theme-d5'><i class='fa fa-windows' aria-hidden='true'></i>  Windows XP/Vista/7/8/10</span>
        <span class='w3-tag w3-small w3-theme-d1'><i class='fa fa-desktop' aria-hidden='true'></i> 5.5 MB</span>
        <span class='w3-tag w3-small w3-theme-l1'><i class='fa fa-wrench' aria-hidden='true'></i> 2.5</span>
        <span class='w3-tag w3-small w3-theme-l2'><i class='fa fa-download' aria-hidden='true'></i>  <a href='#'>Download</a> </span>
		<span class='w3-tag w3-small w3-theme-l3'><i class='fa fa-file-pdf-o' aria-hidden='true'></i>  <a href='#'>Contrato</a></span></center>
		</p>";}?>
...
"<p>Detalhes</p>
        <p>
        <center><span class='w3-tag w3-small w3-theme-d5'><i class='fa fa-windows' aria-hidden='true'></i>  Windows XP/Vista/7/8/10</span>
        <span class='w3-tag w3-small w3-theme-d1'><i class='fa fa-desktop' aria-hidden='true'></i> 1.5 MB</span>
        <span class='w3-tag w3-small w3-theme-l1'><i class='fa fa-wrench' aria-hidden='true'></i> 2.5</span>
        <span class='w3-tag w3-small w3-theme-l2'><i class='fa fa-download' aria-hidden='true'></i>  <a href='#'>Download</a> </span>
		<span class='w3-tag w3-small w3-theme-l3'><i class='fa fa-file-pdf-o' aria-hidden='true'></i>  <a href='#'>Contrato</a></span></center>
		</p>";}?>
        ...
        <p>
        <center><span class="w3-tag w3-small w3-theme-d5"><i class="fa fa-windows" aria-hidden="true"></i>  Windows XP/Vista/7/8/10</span>
        <span class="w3-tag w3-small w3-theme-d1"><i class="fa fa-desktop" aria-hidden="true"></i>  Tamanho: 10.5 MB</span>
        <span class="w3-tag w3-small w3-theme-l1"><i class="fa fa-wrench" aria-hidden="true"></i>  Versão: 2.5</span>
        <span class="w3-tag w3-small w3-theme-l2"><i class="fa fa-download" aria-hidden="true"></i>  <a href="#">Download</a> </span>
		<span class="w3-tag w3-small w3-theme-l3"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>  <a href="#">Contrato</a></span></center>
		</p>-->
