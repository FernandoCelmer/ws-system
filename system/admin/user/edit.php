...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row">
	...
	<h5><i class="fa fa-users"></i>  User - Edit</h5>
	</header>
...
<div class="w3-rest">
      <input class="w3-input w3-border" type="text" value="<?php echo @$exibe['system_user_name']; ?>" placeholder="Name"><p/>
</div>  

<div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-vcard"></i></div>
<div class="w3-rest">
      <input class="w3-input w3-border" type="text" value="<?php echo @$exibe['system_user_code']; ?>" placeholder="Code"><p/>
</div>  

<div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-calendar"></i></div>
<div class="w3-rest">
      <input class="w3-input w3-border" type="text" value="<?php echo @$exibe['system_user_date']; ?>" placeholder="Date"><p/>
</div>  

<div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-phone"></i></div>
<div class="w3-rest">
      <input class="w3-input w3-border" type="text" value="<?php echo @$exibe['system_user_phone']; ?>" placeholder="Phone"><p/>
</div> 
</div>
...
<div class="w3-rest">
      <input class="w3-input w3-border" type="email" value="<?php echo @$exibe['system_user_email']; ?>" placeholder="Email"><p/>
</div>  
...
<select class="w3-select w3-border" name="option">
  <option value="<?php echo @$exibe['system_user_level'];?>"><?php echo @$exibe['system_user_level'];?></option>
...
<div class="w3-rest">
<select class="w3-select w3-border" name="option">
  <option value="<?php echo @$exibe['system_user_status'];?>"><?php echo @$exibe['system_user_status'];?></option>
  <option value="1">0</option>
  <option value="2">1</option>
</select><p/>
</div> 
...
<button class="w3-btn w3-black w3-center">Salvar</button><p/>
</form> 
