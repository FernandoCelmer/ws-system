...
if($_SESSION['system_user_level'] == 1){
	...
	$sql_res=mysql_query("SELECT * FROM system_feedback"); //consulta no banco
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row">
    ...
    <h5><i class="fa fa-eye"></i>  Feedback<?php echo " - Página <a'>".$pag." / ".$paginas."</a>"; ?></h5>
	</header>
  ...
  <div class="w3-row-padding w3-margin-bottom">
		<table class="w3-table w3-small w3-bordered w3-responsive w3-border">
			...
			<?php
				$sql="SELECT * FROM system_feedback ORDER BY system_feedback_attribute DESC LIMIT $inicio, $maximo"; //consulta no BD
